...
public class PagerFragment extends Fragment
{
    ...
    private myPagerTabStrip mPagerTabStrip;
    ...
    private class myPagerTabStrip extends PagerTabStrip{
    ...
    private class myPageAdapter extends FragmentStatePagerAdapter
    {
        ...
        {
            String title = getDayName(getActivity(),System.currentTimeMillis()+((position-2)*86400000));
