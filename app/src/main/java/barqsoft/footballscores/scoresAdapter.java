...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) {
            mHolder.home_crest.setContentDescription(context.getString(R.string.crest_of_cd) + cursor.getString(COL_HOME));
            mHolder.away_crest.setContentDescription(context.getString(R.string.crest_of_cd) + cursor.getString(COL_AWAY));
        }
